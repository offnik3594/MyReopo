...
public class EmulatorBrowserversion {

	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		UiAutomator2Options u=new UiAutomator2Options();
		u.setPlatformName("Android");
		u.setDeviceName("Pixel");
		u.setChromedriverExecutable("D:\\velocitytraining\\setups\\Eclipse_2022_06\\Eclipse_2022_06_WorkSpace\\Appium2_0\\Drivers\\chromedriver.exe");
